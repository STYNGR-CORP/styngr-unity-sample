...
namespace Match3
{
    public class MainMenu : MonoBehaviour
    {
        ...
        private Button styngrSelectPlaylist;

        [SerializeField] private PlaylistController playlistController;

        [SerializeField] private bool filterByMonetizationTypeEnabled;
        ...
        void Start()
        {
            ...
            styngrSelectPlaylist = m_Document.rootVisualElement.Q<Button>("SelectPlaylist");

            if (styngrSelectPlaylist != null)
            {
                styngrSelectPlaylist.clicked += OnSyngrSelectPlaylistClicked;
            }
        ...
        private void OnSyngrSelectPlaylistClicked()
        {
            if (filterByMonetizationTypeEnabled)
            {
                StartCoroutine(playlistController.SelectAdFundedPlaylist());
            }
            else
            {
        ...
        {
            GameManager.SetSelectedPlaylist(playlist);
        }
    }
}
