...
{
    /// <summary>
    /// Strategy for the stynglist pop-up dialog behaviour.
    /// </summary>
    public class StynglistPurchaseStrategy : IPurchaseStrategy
    {
        /// <summary>
        /// Product object (<see cref="Stynglist"/>).
        /// </summary>
        ...
        /// </summary>
        public string CaptionText => "Stynglist Purchase Confirmation";

        /// <summary>
        /// Message of the pop-up dialog.
        /// </summary>
        public string MessageText => "Are you sure you want to buy this stynglist?";
        ...
        /// </summary>
        /// <param name="product">Product object (<see cref="Stynglist"/>).</param>
        ...
        public StynglistPurchaseStrategy(IId product, ProductType productType, Action updateSender)
        {
            Product = product;
        ...
        /// <summary>
        /// Initiates the purchase of the Stynglist.
        /// </summary>
        ...
        public IEnumerator Buy()
        {
            ...
            yield return StoreManager.Instance.StoreInstance.BuyStynglist(Product, onSuccess, main.OnBuyError);
        ...
        public IEnumerator Confirm(ConfigurationJSON jsonConfig, PurchaseInfo purchaseInfo)
        {
            ...
            yield return StoreManager.Instance.StoreInstance.PaymentsConfirm(jsonConfig.XApiToken, paymentInfo, OnSuccess, OnFail);
        }
